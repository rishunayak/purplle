...
const rootReducer = combineReducers({ AuthReducer,ShampooReducer,PrimerReducer,FaceWashReducer,AllUserReducer,UserCartReducer,UserOrderReducer,OrderReducer,CartReducer});
